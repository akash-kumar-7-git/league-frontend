...
const TeamData = () => {
  ...
  useEffect(() => {
    ...
    if (teamValue) {
      ...
      axios.get(`league-backend-production-0d9d.up.railway.app/api/v1/player?nation=${encodeURIComponent(nationValue)}`)
      .then(response => {
        setPlayerData(response.data);
        setLoading(false);
      })
      ...
      axios.get(`league-backend-production-0d9d.up.railway.app/api/v1/player?position=${encodeURIComponent(positionValue)}`)
      .then(response => {
        setPlayerData(response.data);
        setLoading(false);
      })
      ...
      axios.get(`league-backend-production-0d9d.up.railway.app/api/v1/player?name=${encodeURIComponent(nameValue)}`)
      .then(response => {
        setPlayerData(response.data);
        setLoading(false);
      })
